...
La señal de lectura (\code{rdIdx}) gobierna el multiplexor conectado a la salida de los tres
registros. La señal de salida es \code{dout}.
La señal de escritura (\code{wrIdx}) selecciona en qué registro se escribirán los datos
