...
{\bf ¡Enhorabuena! ¡Has conseguido poner en marcha tu primer diseño en Chisel en una FPGA!}
...
{\bf Posible fallo:} un error frecuente al definir constantes con una anchura concreta es olvidar el
...
{\bf Posible fallo:} en Chisel 3 no se permiten las asignaciones parciales, aunque sí estaban
