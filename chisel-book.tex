...
resultará útil un conocimiento básico de la interfaz de línea de órdenes (CLI, también llamada terminal o
consola de Unix).
...
\caption{Estructura de un proyecto en Chisel (usando \code{sbt})}
\label{fig:folders}
\end{figure}
